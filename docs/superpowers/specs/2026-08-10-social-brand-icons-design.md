...
- Preserve a minimum 44-by-44-pixel target, visible keyboard focus, hover feedback, and mobile wrapping.
...
- Make each link square and remove the visible platform text.
