...
export default async function HomePage() {
  ...
  return (
    <main>
      ...
      <section className="container section services-section homepage-deferred-section">
      ...
      <section className="container section gallery-section homepage-deferred-section">
      ...
      <section className="container section faq-section homepage-deferred-section">
